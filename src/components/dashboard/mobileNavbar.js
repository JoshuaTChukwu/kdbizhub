...
class MobileNavbar extends Component {
      render(){
        ...
        function nav_dash(){
            var x = document.getElementById("mob_nav_dash");
            var a = document.getElementById("div_one_dash");
            var b = document.getElementById("div_two_dash");
            var c = document.getElementById("div_three_dash");
	...
	return (
        ...
        <ul>
            <li>
               <NavLink  onClick={nav_dash} to="/dashboard"> <img src={require('./images/Logo.png')} alt="Logo" /> </NavLink>
			</li>
			<li><h2>{this.props.user.username}</h2></li>
            <li onClick={nav_dash}>
                <div id="div_one_dash">.</div>
                <div  id="div_two_dash">.</div>
                <div  id="div_three_dash">.</div>
            </li>
        </ul>
        <ul id="mob_nav_dash">
				<li>
					<NavLink  onClick={nav_dash}  to="/dashboard">	
				...
				<li>
					<NavLink  onClick={nav_dash} to="/transactions">
						<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 30 30">
				...
				<li>
					<NavLink  onClick={nav_dash} to="/products">
						<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 30 30">
				...
				<li>
					<NavLink  onClick={nav_dash} to="/profile">
						<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 30 30">
				...
				<li>
					<NavLink  onClick={nav_dash} to="/logout">
...
export default  connect(matchStateToProps)(MobileNavbar);
